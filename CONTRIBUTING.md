...
When filing an issue, please check [existing open](https://github.com/aws/porting-assistant-dotnet-client/issues) and [closed](https://github.com/aws/porting-assistant-dotnet-client/issues?q=is%3Aissue+is%3Aclosed) issues to make sure somebody else hasn't already reported the issue.
...
3. You check existing [open](https://github.com/aws/porting-assistant-dotnet-client/pulls) and [merged](https://github.com/aws/porting-assistant-dotnet-client/pulls?q=is%3Apr+is%3Aclosed) pull requests to make sure someone else hasn't addressed the problem already.
