...
namespace EncoreCache
{
    ...
    {
        private readonly IEncoreInternalCheckCompatibilityHandler _checker;
        private readonly ILogger<InternalPackagesCompatibilityChecker> _logger;

        public InternalPackagesCompatibilityChecker(IEncoreInternalCheckCompatibilityHandler checker,
