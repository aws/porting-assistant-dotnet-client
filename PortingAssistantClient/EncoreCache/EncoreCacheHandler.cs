...
namespace EncoreCache
{
    ...
    public class EncoreCacheHandler : IEncoreCacheHandler
    {
        private readonly ILogger<EncoreCacheHandler> _logger;
        ...
        public EncoreCacheHandler(
            ILogger<EncoreCacheHandler> logger,
