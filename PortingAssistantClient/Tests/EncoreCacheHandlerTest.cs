...
namespace EncoreCacheTest
{
    public class EncoreCacheHandlerTest
    {
        private Mock<ITransferUtility> _transferUtilityMock;
        private Mock<IEncoreInternalCheckCompatibilityHandler> _checkComptHanderMock;
        ...
        private Mock<ILogger<EncoreCacheHandler>> _logger;
        ...
        public void OneTimeSetup()
        {
            ...
            _checkComptHanderMock = new Mock<IEncoreInternalCheckCompatibilityHandler>();
        }
        ...
        private IEncoreCacheHandler GetExternalCacheHandler()
        {
            var checkers = new List<ICompatibilityChecker>() { _externalChecker };
            return new EncoreCacheHandler(
                    NullLogger<EncoreCacheHandler>.Instance,
                    checkers.AsEnumerable()
                    );
        }

        private IEncoreCacheHandler GetInternalCacheHandler()
        {
        ...
        private IEncoreCacheHandler GetBothCacheHandler()
        {
        ...
        private IEncoreCacheHandler GetCheckerWithException()
        {
            ...
            _logger = new Mock<ILogger<EncoreCacheHandler>>();
        ...
        {
            var handler = GetExternalCacheHandler();
        ...
        {
            var handler = GetInternalCacheHandler();
        ...
        public void TestNotExists()
        {
            ...
            var handler = GetBothCacheHandler();
