...
namespace EncorePrivateCompatibilityCheckTests
{
    public class CheckCompatibilityHandlerTest
    {
        IEncoreInternalCheckCompatibilityHandler checker;
        ...
        public void Setup()
        {
            checker = new EncoreInternalCheckCompatibilityHandler(NullLogger<EncoreInternalCheckCompatibilityHandler>.Instance);
