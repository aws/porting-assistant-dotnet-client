...
namespace EncoreAssessment
{
    public class AssessmentHandler : IAssessmentHandler
    {
        ...
        private readonly IEncoreCacheHandler _cache;
        private readonly IEncoreApiAnalysisHandler _apiAnalysis;

        public AssessmentHandler(ILogger<AssessmentHandler> logger,
            IEncoreCacheHandler cache,
            IEncoreApiAnalysisHandler apiAnalysis)
        {
            _logger = logger;
            _cache = cache;
