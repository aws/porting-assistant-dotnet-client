...
{
    public class EncoreInternalCheckCompatibilityHandler : IEncoreInternalCheckCompatibilityHandler
    {
        private readonly ILogger _logger;
        private readonly SourceCacheContext cacheContext;

        public EncoreInternalCheckCompatibilityHandler(ILogger<EncoreInternalCheckCompatibilityHandler> logger)
        {
            _logger = logger;
