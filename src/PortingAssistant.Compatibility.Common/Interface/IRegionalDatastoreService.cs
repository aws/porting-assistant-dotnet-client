namespace PortingAssistant.Compatibility.Common.Interface
{
    ...
    {
        public Task<string?> DownloadRegionalS3FileAsync(string fileToDownload, bool isRegionalCall = false);
        ...
        public Task<string?> ParseS3ObjectToString(Stream stream, string fileToDownload);
    }
}
